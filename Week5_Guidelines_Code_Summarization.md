...
```
Bad: "Summarize all code files in this repository and explain how the project should be run."
Good: "Starting from train.sh in plm_retrieval, summarize the code logic in plm_retrieval for data processing, data loading, pretraining, and testing.

```

## 2. Guidelines used in each Problem

| Problem      | Guidelines Used |
| ----------- | ----------- |
| C/C++      | 2, 3, 4       |
| Matlab   | 1, 2, 3, 5        |
| React      | 1, 2, 3       |
